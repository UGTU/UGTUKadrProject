...
AS
SELECT     TOP (100) PERCENT dbo.Audit_Object.ObjectName, dbo.Audit_Object.ObjectTable, dbo.Audit_OperationType.OperationName, dbo.Audit_Event.AuditDateTime, 
                      dbo.Audit_Event.UserName, dbo.Audit_Event.Description
...
ORDER BY dbo.Audit_Event.AuditDateTime
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'AuditView';
