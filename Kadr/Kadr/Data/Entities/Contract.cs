...
namespace Kadr.Data
{
    ...
    public partial class Contract : IValidatable
    {
        ...
        public Contract(ICommandManager CommandManager, FactStaffHistory factStaffHistory, string contractName = "", DateTime? dateContract = null, DateTime? dateBegin = null, DateTime? dateEnd = null)
            : this()
        {
